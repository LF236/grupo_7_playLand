...
CREATE TABLE User(id varchar(36) NOT NULL, PRIMARY KEY(id) ,email varchar(100) NOT NULL, password varchar(50) NOT NULL, name varchar(50) NOT NULL, last_name varchar(50) NOT NULL, image TEXT NOT NULL, role BOOLEAN DEFAULT false);
